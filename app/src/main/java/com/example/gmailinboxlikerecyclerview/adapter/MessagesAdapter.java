package com.example.gmailinboxlikerecyclerview.adapter;
...
import com.example.gmailinboxlikerecyclerview.activity.MainActivity;
import com.example.gmailinboxlikerecyclerview.helper.CircleTransform;
import com.example.gmailinboxlikerecyclerview.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    public MessagesAdapter(Context context, List<Message> msgList, MessageAdapterListener listener) {
    ...
    private void applyClickEvent(MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        public TextView from,subject,messageTv,iconText,timestamp;
        ...
        public MyViewHolder(@NonNull View view) {
            ...
            messageTv = (TextView) view.findViewById(R.id.txt_secondary);
